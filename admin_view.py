...
@admin_view.route('/admin-profile', methods=['GET', 'POST'])
@login_required
def admin_profile():
...
@admin_view.route('/create_event', methods=['GET', 'POST'])
def create_event():
    form = EventForm()
...
@admin_view.route('/edit_event/<int:event_id>', methods=['GET', 'POST'])
